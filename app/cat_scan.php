...
if (isset($_POST['scan'])) {
    ...
    $scan    = mysql_query("SELECT products.product_name_cat,brands.brand_name,products.product_price,products.product_size_cat,products.product_image FROM products,brands WHERE brands.brand_id=products.product_brand and products.product_barcode='$barcode' LIMIT 1");
