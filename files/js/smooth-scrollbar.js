! function(t) {
    ...
    var a = n(60),
        c = r(a);
    n(199), window.Scrollbar = c.default, Prism.highlightAll(), document.getElementById("version").textContent = c.default.version, window.innerWidth < 800 && [].concat(o(document.querySelectorAll("pre, table"))).forEach(function(t) {
        var e = document.createElement("div");
        e.className = "wrap", t.parentNode.insertBefore(e, t), e.appendChild(t), c.default.init(e)
    })
}, function(t, e, n) {
    t.exports = {
        default: n(3),
    ...
    t.exports = function(t, e, n, g, m, b, x) {
        ...
        var S, M, w, E = function(t) {
            ...
            k = T[d] || T[v] || m && T[m],
            j = k || E(m),
            L = m ? P ? E("entries") : j : void 0,
            R = "Array" == e ? T.entries || k : k;
        if (R && (w = s(R.call(new t)), w !== Object.prototype && w.next && (f(w, O, !0), r || a(w, d) || u(w, d, y))), P && k && k.name !== _ && (A = !0, j = function() {
                return k.call(this)
            }), r && !x || !h && !A && T[d] || u(T, d, j), c[e] = j, c[O] = y, m)
            if (S = {
                    values: P ? j : E(_),
                    keys: b ? j : E(p),
                    entries: L
                }, x)
                for (M in S) M in T || i(T, M, S[M]);
            else o(o.P + o.F * (h || A), e, S);
        return S
    }
}, function(t, e) {
    t.exports = !0
    ...
    var r = n(11),
        ...
        c = function(t, e, n) {
            var l, f, s, d = t & c.F,
                ...
                b = h ? r : v ? r[e] : (r[e] || {})[a];
            h && (n = e);
            for (l in n) f = !d && b && void 0 !== b[l], f && l in g || (s = f ? b[l] : n[l], g[l] = h && "function" != typeof b[l] ? n[l] : _ && f ? i(s, r) : y && b[l] == s ? function(t) {
                ...
                return e[a] = t[a], e
            }(s) : p && "function" == typeof s ? i(Function.call, s) : s, p && ((g.virtual || (g.virtual = {}))[l] = s, t & c.R && m && !m[l] && u(m, l, s)))
        };
    ...
    o(o.S + o.F * !n(54)(function(t) {
        ...
        from: function(t) {
            var e, n, o, s, d = i(t),
                ...
                y = 0,
                g = f(d);
            if (_ && (p = r(p, v > 2 ? arguments[2] : void 0, 2)), void 0 == g || h == Array && a(g))
                for (e = c(d.length), n = new h(e); e > y; y++) l(n, y, _ ? p(d[y], y) : d[y]);
            else
                for (s = g.call(d), n = new h; !(o = s.next()).done; y++) l(n, y, _ ? u(s, p, [o.value, y], !0) : o.value);
            return n.length = y, n
        }
    })
}, function(t, e, n) {
    ...
    function o() {
        ...
        if (!t || Math.abs(t) > Math.pow(10, -2)) return t.toFixed(2);
        for (var e = -3; !(t / Math.pow(10, e) | 0);) {
            if (e < -10) return t > 0 ? "Infinity" : "-Infinity";
            e--
        }
        return (t * Math.pow(10, -e)).toFixed(2) + "e" + e
    }
    ...
    function u() {
        var t = Math.floor(D.length * (1 - C)),
            e = D[D.length - 1],
            n = 0,
            r = D.filter(function(r, o) {
                if (e.time - r.time > w) return n++, void t--;
                var i = D[t - 1];
                return i.time - r.time <= 1e3 * R.duration && o <= t
            });
        return D.splice(0, n), I = r.length ? r.length / D.length : 1, O.style.width = 100 * I + "%", O.style.right = 100 * C + "%", r
    }
    ...
    function c(t) {
        t && (0, m.default)(t).forEach(function(e) {
            T[e] = t[e]
        })
    }
    ...
    function l(t, e, n) {
        var r = t[0],
            ...
            i = e[0],
            u = e[1];
        c(n.props), T.save(), T.transform(1, 0, 0, -1, 0, k.height), T.beginPath(), T.setLineDash(n.dashed ? n.dashed : []), T.moveTo(r, o), T.lineTo(i, u), T.stroke(), T.closePath(), T.restore()
    }

    function f(t, e, n) {
        var r = e[0],
            o = e[1],
            i = T.measureText(t).width;
        r + i > k.width ? T.textAlign = "right" : r - i < 0 ? T.textAlign = "left" : T.textAlign = n.textAlign, T.fillText(t, r, -o)
    }

    function s(t, e, n) {
        c(n.props), T.save(), T.transform(1, 0, 0, 1, 0, k.height), f(t, e, n), T.restore()
    }
    ...
    function d() {
        ...
        if (t.length) {
            var e = a(t),
                n = t[0],
                r = t[t.length - 1],
                i = 1 === I ? 1e3 * R.duration : r.time - n.time,
                c = e.max - e.min || 1,
                f = T.createLinearGradient(0, k.height, 0, 0);
            f.addColorStop(0, "rgb(170, 215, 255)"), f.addColorStop(1, "rgba(170, 215, 255, 0.2)"), T.save(), T.transform(1, 0, 0, -1, 0, k.height), T.lineWidth = 1, T.fillStyle = f, T.strokeStyle = "rgb(64, 165, 255)", T.beginPath(), T.moveTo(0, 0);
            var d = t.reduce(function(r, o, u) {
                var a = o.time,
                    l = o[R.data],
                    f = (a - n.time) / i * k.width,
                    s = (l - e.min) / c * (k.height - 20);
                return T.lineTo(f, s), G && Math.abs(G - f) < z && (F = {
                    coord: [f, s],
                    point: o
                }, B = {
                    coord: r,
            ...
            T.stroke(), T.lineTo(d[0], 0), T.fill(), T.closePath(), T.restore(), l([0, d[1]], d, {
                props: {
                    strokeStyle: "#f60"
                }
            }), s("?" + o(e.min), [0, 0], {
    ...
    function h() {
        var t = F.coord,
            ...
            n = (t[1] - e[1]) / (t[0] - e[0]) || 0,
            r = t[1] - n * t[0];
        l([0, r], [k.width, n * k.width + r], {
            props: {
                lineWidth: 1,
                strokeStyle: "#f00"
            }
        });
        var i = (F.point[R.data] - B.point[R.data]) / (F.point.time - B.point.time);
        s("dy/dx: " + o(i), [k.width / 2, 0], {
            props: {
                fillStyle: "#f00",
                textAlign: "center",
                textBaseline: "bottom",
    ...
    function v() {
        if (F) {
            ...
            l([0, t[1]], [k.width, t[1]], n), l([t[0], 0], [t[0], k.height], n);
            var r = new Date(e.time + e.reduce),
                i = ["(", r.getMinutes(), ":", r.getSeconds(), ".", r.getMilliseconds(), ", ", o(e[R.data]), ")"].join("");
            s(i, t, {
                props: {
                    fillStyle: "#000",
                    textAlign: "left",
    ...
    function p() {
        return N ? (T.save(), T.clearRect(0, 0, k.width, k.height), s(R.data.toUpperCase(), [0, k.height], {
            props: {
                fillStyle: "#f00",
                textAlign: "left",
                textBaseline: "top",
        ...
        }), d(), v(), H && s("LOCKED", [k.width, k.height], {
            props: {
                fillStyle: "#f00",
                textAlign: "right",
                textBaseline: "top",
        ...
        }), T.restore(), N = !1, void(W = requestAnimationFrame(p))) : void(W = requestAnimationFrame(p))
    }
    ...
    var g = n(56),
        ...
        w = 2e4,
        O = document.getElementById("thumb"),
        P = document.getElementById("track"),
        A = document.getElementById("chart"),
        T = A.getContext("2d"),
        k = {
            width: 300,
            height: 200
        };
    A.width = k.width * M, A.height = k.height * M, T.scale(M, M);
    var j = x.default.get(document.getElementById("main-scrollbar")),
        //L = S.controller.addFolder("Monitor"),
        R = {
            show: window.innerWidth > 600,
            data: "offset",
            duration: 5,
            reset: function() {
                D.length = C = X = 0, H = !1, G = void 0, F = null, B = null, u()
            }
        },
        I = 0,
        C = 0,
        ...
        B = null,
        H = !1,
        z = "ontouchstart" in document ? 5 : 1,
        G = void 0,
        V = void 0,
        W = void 0;
    R.show && (E.style.display = "block", W = requestAnimationFrame(p)), L.add(R, "reset"), L.add(R, "data", ["offset", "speed"]).onChange(function() {
        N = !0
    }), L.add(R, "show").onChange(function(t) {
        t ? (E.style.display = "block", W = requestAnimationFrame(p)) : (E.style.display = "none", cancelAnimationFrame(W))
    }), L.add(R, "duration", 1, 20).onChange(function() {
        N = !0;
        var t = D[0],
            e = D[D.length - 1];
        e && (C = Math.min(C, Math.max(0, 1 - 1e3 * R.duration / (e.time - t.time))))
    });
    var U = Date.now(),
        q = 0,
        X = 0;
    j.addListener(function() {
        var t = Date.now(),
            e = j.offset.y,
            n = t - U;
        if (n && e !== q) {
    ...
    }), i(A, "mousemove touchmove", function(t) {
        if (!H && !V) {
            var e = _(t);
            G = e.clientX - A.getBoundingClientRect().left
        }
    }), i([A, window], "mouseleave touchend", function() {
        H || y()
    }), i(A, "click", function() {
        H = !H, H || y()
    }), i(O, "mousedown touchstart", function(t) {
        var e = _(t);
        V = e.clientX
    }), i(window, "mousemove touchmove", function(t) {
        if (V) {
            var e = _(t),
                n = (e.clientX - V) / k.width;
            V = e.clientX, C = Math.min(1 - I, Math.max(0, C - n))
        }
    }), i(window, "mouseup touchend blur", function() {
        V = void 0
    }), i(O, "click touchstart", function(t) {
        t.stopPropagation()
    }), i(P, "click touchstart", function(t) {
        var e = _(t),
            n = P.getBoundingClientRect(),
            r = (e.clientX - n.left) / n.width;
        C = Math.min(1 - I, Math.max(0, 1 - (r + I / 2)))
    })
}, function(t, e, n) {
    t.exports = {
        default: n(57),
    ...
    n(58), t.exports = n(12).Object.keys
}, function(t, e, n) {
    var r = n(47),
        o = n(31);
    n(59)("keys", function() {
    ...
    var s = "function" == typeof f.default && "symbol" == typeof c.default ? function(t) {
        ...
        d = n(84),
        h = n(94);
    n(136), n(152), n(165), n(180), n(194), e.default = d.SmoothScrollbar, d.SmoothScrollbar.version = "7.4.1", d.SmoothScrollbar.init = function(t, e) {
    ...
    n(4), n(63), t.exports = n(67).f("iterator")
}, function(t, e, n) {
    n(64);
    ...
    n(70), n(81), n(82), n(83), t.exports = n(12).Symbol
}, function(t, e, n) {
    "use strict";
    var r = n(11),
        o = n(26),
        ...
        X = G && "symbol" == typeof j.iterator ? function(t) {
            return "symbol" == typeof t
        } : function(t) {
            return t instanceof j
        },
        K = function(t, e, n) {
            return t === z && K(H, e, n), m(t), e = x(e, !0), m(n), o(B, e) ? (n.enumerable ? (o(t, C) && t[C][e] && (t[C][e] = !1), n = M(n, {
                enumerable: S(0, !1)
            })) : (o(t, C) || T(t, C, S(1, {})), t[C][e] = !0), U(t, e, n)) : T(t, e, n)
        },
        J = function(t, e) {
            m(t);
        ...
        Q = function(t) {
            ...
            return !(this === z && o(B, t) && !o(H, t)) && (!(e || !o(this, t) || !o(B, t) || o(this, C) && this[C][t]) || e)
        },
        Z = function(t, e) {
            if (t = b(t), e = x(e, !0), t !== z || !o(B, e) || o(H, e)) {
                var n = A(t, e);
                return !n || !o(B, e) || o(t, C) && t[C][e] || (n.enumerable = !0), n
            }
        },
        $ = function(t) {
            for (var e, n = k(b(t)), r = [], i = 0; n.length > i;) o(B, e = n[i++]) || e == C || e == c || r.push(e);
            return r
        },
        tt = function(t) {
            for (var e, n = t === z, r = k(n ? H : b(t)), i = [], u = 0; r.length > u;) !o(B, e = r[u++]) || n && !o(z, e) || i.push(B[e]);
            return i
        };
    G || (j = function() {
        ...
        var t = d(arguments.length > 0 ? arguments[0] : void 0),
            e = function(n) {
                this === z && e.call(H, n), o(this, C) && o(this[C], t) && (this[C][t] = !1), U(this, t, S(1, n))
            };
        return i && W && U(z, t, {
            configurable: !0,
            set: e
        }), q(t)
    }, a(j[I], "toString", function() {
        return this._k
    }), E.f = Z, O.f = K, n(79).f = w.f = $, n(76).f = Q, n(75).f = tt, i && !n(9) && a(z, "propertyIsEnumerable", Q, !0), v.f = function(t) {
        return q(h(t))
    }), u(u.G + u.W + u.F * !G, {
        Symbol: j
    });
    for (var et = "hasInstance,isConcatSpreadable,iterator,match,replace,search,species,split,toPrimitive,toStringTag,unscopables".split(","), nt = 0; et.length > nt;) h(et[nt++]);
    for (var rt = P(h.store), ot = 0; rt.length > ot;) p(rt[ot++]);
    u(u.S + u.F * !G, "Symbol", {
        for: function(t) {
    ...
    }), j[I][D] || n(15)(j[I], D, j[I].valueOf), s(j, "Symbol"), s(Math, "Math", !0), s(r.JSON, "JSON", !0)
}, function(t, e, n) {
    var r = n(41)("meta"),
        o = n(18),
        i = n(26),
    ...
    e.SmoothScrollbar = function() {
        function t(e) {
            ...
            if (e.scrollLeft = e.scrollTop = 0, this.setPosition(s, v, !0), d.sbList.set(e, this), "function" == typeof d.GLOBAL_ENV.MutationObserver) {
                var p = new d.GLOBAL_ENV.MutationObserver(function() {
                    n.update(!0)
                });
                p.observe(i, {
                    childList: !0
    ...
    n(90), t.exports = n(12).Object.freeze
}, function(t, e, n) {
    var r = n(18),
        o = n(71).onFreeze;
    ...
    n(81), n(4), n(63), n(100), n(111), n(114), n(116), t.exports = n(12).Map
}, function(t, e, n) {
    "use strict";
    var r = n(101),
        o = n(106),
        i = "Map";
    t.exports = n(107)(i, function(t) {
        return function() {
    ...
    t.exports = {
        getConstructor: function(t, e, n, l) {
            var f = t(function(t, r) {
                a(t, f, e, "_i"), t._t = e, t._i = o(null), t._f = void 0, t._l = void 0, t[p] = 0, void 0 != r && c(r, n, t[l], t)
            });
        ...
        e = t.exports = function(t, e, n, s, d) {
            ...
            if (i(y)) {
                for (h = a(t.length); h > m; m++)
                    if (_ = e ? g(u(v = t[m])[0], v[1]) : g(t[m]), _ === l || _ === f) return _
            } else
                for (p = y.call(t); !(v = p.next()).done;)
                    if (_ = o(p, g, v.value, e), _ === l || _ === f) return _
        };
    ...
    var r = n(11),
        ...
        v = n(108)(0),
        p = n(20);
    t.exports = function(t, e, n, _, y, g) {
        var m = r[t],
            b = m,
            x = y ? "set" : "add",
            S = b && b.prototype,
            M = {};
        return p && "function" == typeof b && (g || S.forEach && !u(function() {
            (new b).entries().next()
        })) ? (b = e(function(e, n) {
            f(e, b, t, "_c"), e._c = new m, void 0 != n && l(n, y, e[x], e)
        }), v("add,clear,delete,forEach,get,has,set,keys,values,entries,toJSON".split(","), function(t) {
            var e = "add" == t || "set" == t;
            t in S && (!g || "clear" != t) && a(b.prototype, t, function(n, r) {
                if (f(this, b, t), !e && g && !s(n)) return "get" == t && void 0;
        ...
        })) : (b = _.getConstructor(e, t, y, x), c(b.prototype, n), i.NEED = !0), d(b, t), M[t] = b, o(o.G + o.W + o.F, M), g || _.setStrong(b, t, y), b
    }
}, function(t, e, n) {
    var r = n(13),
        o = n(34),
    ...
    t.exports = function(t, e) {
        ...
        return function(e, a, v) {
            for (var p, _, y = i(e), g = o(y), m = r(a, v, 3), b = u(g.length), x = 0, S = n ? h(e, b) : c ? h(e, 0) : void 0; b > x; x++)
                if ((d || x in g) && (p = g[x], _ = m(p, x, y), t))
                    if (n) S[x] = _;
                    else if (_) switch (t) {
                case 3:
                    return !0;
    ...
    n(134), t.exports = n(12).Object.assign
}, function(t, e, n) {
    var r = n(10);
    r(r.S + r.F, "Object", {
        assign: n(135)
    ...
    t.exports = !c || n(21)(function() {
        ...
        for (var n = u(t), c = arguments.length, l = 1, f = o.f, s = i.f; c > l;)
            for (var d, h = a(arguments[l++]), v = f ? r(h).concat(f(h)) : r(h), p = v.length, _ = 0; p > _;) s.call(h, d = v[_++]) && (n[d] = h[d]);
        return n
    } : c
}, function(t, e, n) {
    "use strict";
    ...
    o.SmoothScrollbar.prototype.scrollTo = function() {
        ...
        var f = a.x,
            ...
            p = (0, r.buildCurve)(h, o),
            _ = v.length,
            y = 0,
            g = function t() {
                n.setPosition(f + v[y], s + p[y]), y++, y === _ ? requestAnimationFrame(function() {
                    i(n)
    ...
    function o(t) {
        ...
        var d = (0, u.pickInRange)(Math.abs(t) / o, 0, a),
            ...
            v = Math.abs(t),
            p = r.getLastPosition("y") || f / 2;
        s.globalAlpha = d, s.beginPath(), s.moveTo(0, -h), s.quadraticCurveTo(v, p, 0, f + h), s.fill(), s.closePath(), s.restore()
    }
    ...
    function i(t) {
        ...
        var d = (0, u.pickInRange)(Math.abs(t) / o, 0, a),
            ...
            p = Math.abs(t);
        s.globalAlpha = d, s.beginPath(), s.moveTo(-h, 0), s.quadraticCurveTo(v, p, l + h, 0), s.fill(), s.closePath(), s.restore()
    }
    Object.defineProperty(e, "__esModule", {
        value: !0
    }), e.overscrollGlow = r;
        ...
        this.__addEvent(n, "click", function(e) {
            if (!l && (0, i.isOneOf)(e.target, [r.track, o.track])) {
                ...
                if ("x" === c) {
                    ...
                    var p = s.y - f.top - h.y / 2;
                    t.__setMovement(0, u(c, p) - d.y)
                }
            }
        ...
        (0, l.default)(n).filter(function(t) {
            ...
            (0, a.default)(u, t, {
                ...
                set: function(e) {
                    ...
                    n[t] = m.pickInRange.apply(void 0, [e].concat(o(r[t])))
                }
            })
    ...
    var u = n(91),
        ...
        _ = n(68),
        y = r(_),
        g = "function" == typeof y.default && "symbol" == typeof p.default ? function(t) {
            return typeof t
        } : function(t) {
    ...
    var l = n(60),
        ...
        v = f.default.initAll(s),
        p = new dat.GUI;
    p.addFolder("Scrollbar Options"), document.getElementById("controller").appendChild(p.domElement);
    var _ = function() {
        return v.forEach(function(t) {
            return t.setOptions(s)
        })
    };
    window.innerWidth < 600 && p.close(), (0, u.default)(s).forEach(function(t) {
        var e = void 0;
        if (d.hasOwnProperty(t)) {
            var n = d[t];
            "range" === n.type && (e = p.add.apply(p, [s, t].concat(o(n.value)))), "select" === n.type && (e = p.add(s, t, n.value))
        } else e = "overscrollEffectColor" === t ? p.addColor(s, t) : p.add(s, t);
        e.onChange(function(e) {
            h.hasOwnProperty(e) && (s[t] = h[e]), _()
        })
    }), e.controller = p
}, function(t, e) {}]);