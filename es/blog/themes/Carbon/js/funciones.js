...
function remind_password(gew){
   close_login_box();
	...
	var form = '';
        ...
        form += '<label class="label" for="r_email">Correo electr&oacute;nico:</label>'
        form += '<input class="input" type="text" tabindex="1" name="r_email" id="r_email" maxlength="35"/>'
  		form += '</div>'
		form += '</div>'
        //
...
var afiliado = {
    ...
    nuevo: function(){
        // CARGAMOS Y BORRAMOS
        var form = '';
        form += '<div class="notification is-info has-text-centered" id="AFStatus"><span>Ingresa los datos de tu web para afiliarte.</span></div>'
        form += '<div  id="AFormInputs">'
        form += '<div class="control">'
        form += '<label class="label" for="atitle">T&iacute;tulo</label>'
        form += '<input class="input" type="text" tabindex="1" name="atitle" id="atitle" maxlength="35"/>'
  		form += '</div>'
        form += '<div class="control">'
        form += '<label class="label" for="aurl">Direcci&oacute;n</label>'
        form += '<input class="input" type="text" tabindex="2" name="aurl" id="aurl" value="http://"/>'
  		form += '</div>'
        form += '<div class="control">'
        form += '<label class="label" for="aimg">Banner <small>(216x42px)</small></label>'
        form += '<input class="input" type="text" tabindex="3" name="aimg" id="aimg" value="http://"/>'
  		form += '</div>'
        form += '<div class="control">'
        form += '<label class="label" for="atxt">Descripci&oacute;n</label>'
        form += '<textarea class="textarea" tabindex="4" rows="10" name="atxt" id="atxt" style="height:60px; width:295px"></textarea>'
  		form += '</div>'
        form += '<div class="control">'
        form += '<label class="label" for="aID">RefID <a href="#" onclick="$(this).parent().parent().find('
        ...
        form += '<input type="text" tabindex="5" name="aID" id="aID" value="" class="input"/>'
  		form += '</div>'
        form += '</div>'
        //
        mydialog.class_aux = 'registro';
