...
$(document).ready(function(){
	...
	favoritos.template_favorito = '<tr id="favorito_id___fav_id__"><td><img src="'+ global_data.img +'images/icons/cat/__imagen__" title="__categoria_name__"/></td><td><a class="titlePost" title="__titulo__" href="__url__">__titulo__</a></td><td class="is-hidden-touch" title="__fecha_creado_formato__">__fecha_creado_palabras__</td><td class="is-hidden-touch" title="__fecha_guardado_formato__">__fecha_guardado_palabras__</td><td>__puntos__</td><td class="is-hidden-touch">__comentarios__</td><td><a id="change_status" href="" onclick="favoritos.eliminar(__fav_id__, this); return false;"><span class="icon is-small"><i class="fa fa-times-circle"></i></span></a></td></tr>';
	favoritos.template_categoria = '<li class="panel-block" id="cat___categoria__"><a href="" onclick="favoritos.active(this); favoritos.categoria = \'__categoria__\'; favoritos.query(); return false;">__categoria_name__</a> (<span class="count">__count__</span>)</li>';
