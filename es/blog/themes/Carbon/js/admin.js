...
medallas : {
   ...
   asignar:function(mid, gew){
	...
	var form = '';
        ...
        form += '<label class="label" for="m_usuario">Al usuario (nombre):</label>'
        form += '<input class="input" name="m_usuario" id="m_usuario"/><br />'
		form += '<label class="label" for="m_post">Al post (id):</label>'
        form += '<input class="input" name="m_post" id="m_post"/><br />'
 		form += '<label class="label" for="m_foto">A la foto (id):</label>'
        form += '<input class="input" name="m_foto" id="m_foto"/>'
		form += '</div>'
		form += '</div>'
        //
