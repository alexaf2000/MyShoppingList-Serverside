                                <p class="title">Centro de Moderaci&oacute;n</p>
							   <div class="columns notification is-info">
								<div class="column is-1 has-text-centered">
								<span class="icon is-large"><i class="fa fa-institution"></i></span>
								</div>
								<div class="column is-11"><b>Hola {$tsUser->nick}!</b><br />Si est&aacute;s viendo esto significa que tienes el privilegio de ser moderador en <b>{$tsConfig.titulo}</b>, por favor lee el protocolo de moderadores para mantener todo en orden.
                                    </div>
								</div>
