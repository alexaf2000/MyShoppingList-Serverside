<div class="columns">
	...
	<div class="box">
		<h2 class="title is-2">Chat {$tsConfig.titulo}</h2>
	<div class="box_cuerpo">	
		...
		{else}
        <div class="notification is-info has-text-centered"><span class="icon"><i class="fa fa-info-circle"></i></span><span>Estamos por agregar el chat para que todos ustedes se puedan divertir y hacer nuevos amigos.</span></div>
        {/if}		
	</div>
