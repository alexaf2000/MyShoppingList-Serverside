<script src="{$tsConfig.js}/tags.js" type="text/javascript" ></script>
{literal}
...
$(document).ready(function(){
	...
	$('input[name=preview]').bind('click',function(){
		var error = false;
			...
			mydialog.show(true);
			mydialog.title('...');
			mydialog.body('<p class="has-text-centered">Cargando vista previa....<br><br><i class="fa fa-spinner fa-pulse fa-3x"></i></p>');
            mydialog.center();
            // PREVIEW
			$.ajax({
				type: 'post',
