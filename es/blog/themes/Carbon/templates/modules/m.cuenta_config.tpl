							<div class="content-tabs privacidad" style="display:none">
								...
								<fieldset>
									...
									<div class="notification is-info has-text-centered alert-cuenta cuenta-7"></div>
                                    
									<h2 class="title is-5">&iquest;Qui&eacute;n puede...</h2>
                                    
									<div class="control is-horizontal">
                    					
										<div class="control-label"><label class="label">ver tu muro?</label></div>
                    					
										<div class="input-fake control is-grouped">
                    						
											<div class="select"><select name="muro" class="cuenta-save-7">
									...
									<div class="control is-horizontal">
										...
										<div class="control-label"><label class="label">firmar tu muro?</label></div>
                    					
										<div class="input-fake control is-grouped">
                    						
											<div class="select"><select name="muro_firm" class="cuenta-save-7">
									...
									<div class="control is-horizontal">
										...
										<div class="control-label"><label class="label">ver &uacute;ltimas visitas?</label></div>
                    					
										<div class="input-fake control is-grouped">
                    						
											<div class="select"><select name="last_hits" class="cuenta-save-7">
									...
									<div class="control is-horizontal">
										...
										<div class="control-label"><label class="label">enviarte MPs?</label></div>
                    					
										<div class="input-fake control is-grouped">
                    						
											<div class="select"><select name="rec_mps" class="cuenta-save-7">
								...
								<div class="buttons">
									...
									<input type="button" value="Guardar" onclick="cuenta.save(7)" class="button is-primary">
